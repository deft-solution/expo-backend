...
export class AuthenticationController {
  ...
  @POST('/v1/email/valid')
  async checkIfEmailIsExisted(@ContextRequest request: express.Request<any, any, IUser>) {
  ...
  async checkIfUserNameExisted(@ContextRequest request: express.Request<any, any, IUser>) {
